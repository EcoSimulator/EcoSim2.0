...
class PopMonitor:
    ...
    def make_monitor(self, screen, itr, species):
        ...
        #button
        button = pygame.image.load(os.path.join(sidebar_dir, "popbutton" + png_ext))
        button_rect = Rect((start_x+36, start_y+0), (90, 27))

        #sprite
        sprite = pygame.image.load((os.path.join(sprites_dir, species + png_ext)))
